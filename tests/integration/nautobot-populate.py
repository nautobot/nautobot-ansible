...
parent_location_attrs = [
    ...
    {
        "name": "{{ ANSIBLE UNSAFE HANDLING TEST }}Parent Test Location 3",
        "location_type": parent_location_type.id,
        "tenant": test_tenant.id,
        "status": {"name": "Active"},
    },
...
location_parent3 = nb.dcim.locations.get(name="{{ ANSIBLE UNSAFE HANDLING TEST }}Parent Test Location 3")
...
racks = [
    ...
    {
        "name": "Another Test Rack",
        "location": location_parent3.id,
        "rack_group": rack_group_parent3.id,
        "role": rack_role1.id,
        "status": {"name": "Active"},
    },
]
...
devices = [
    ...
    {
        "name": "R2 {{ ANSIBLE UNSAFE HANDLING TEST }}",
        "device_type": cisco_test.id,
        "role": core_switch.id,
        "location": location_parent3.id,
        ...
        "local_config_context_data": {
            ...
            "string_containing_jinja2tags": "this is a string containing Jinja2 tags {{ ANSIBLE UNSAFE HANDLING TEST }}",
        },
        "status": {"name": "Active"},
    },
    {
...
test_device_r2 = nb.dcim.devices.get(name="R2 {{ ANSIBLE UNSAFE HANDLING TEST }}")

# Create inventory items
inventory_items = [
    {
        "name": "Test Parent Inventory Item",
        "device": test100.id,
        "label": "Test Parent Inventory Item",
    },
]
