...
short_description: Creates or removes cloud network prefix assignments from Nautobot
description:
  - Creates or removes cloud network prefix assignments from Nautobot
notes:
...
- name: "Test Nautobot modules"
  ...
  tasks:
    ...
    - name: Delete cloud_network_prefix_assignment within nautobot
      networktocode.nautobot.cloud_network_prefix_assignment:
        url: http://nautobot.local
        token: thisIsMyToken
        state: absent
