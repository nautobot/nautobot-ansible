...
"""Ansible plugin definition for graphql_facts action plugin."""
...
DOCUMENTATION = """
---
module: graphql_facts
author: Josh VanDeraa (@jvanderaa)
version_added: "6.2.0"
short_description: Queries Nautobot GraphQL endpoint and sets returned data as Ansible facts
description:
    - Queries Nautobot via its GraphQL API through pynautobot and sets the returned data as Ansible facts
requirements:
    - pynautobot
options:
    graph_variables:
...
def main():
    """Main definition of Action Plugin for graphql_facts."""
