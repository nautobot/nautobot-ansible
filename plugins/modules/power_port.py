...
options:
  device:
    description:
      ...
      - Requires one of I(device) or I(module) when I(state=present) and the power port does not exist yet
    required: false
    type: raw
    version_added: "3.0.0"
  name:
    description:
      ...
      - Required if I(state=present) and the power port does not exist yet
    required: false
    type: str
    version_added: "3.0.0"
  type:
