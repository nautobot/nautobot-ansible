...
---
module: power_port
short_description: Creates or removes power ports from Nautobot
description:
  - Creates or removes power ports from Nautobot
notes:
...
- name: "Test Nautobot modules"
  ...
  tasks:
    - name: Create power_port within Nautobot with only required information
      networktocode.nautobot.power_port:
        url: http://nautobot.local
        token: thisIsMyToken
        name: Test Power_Port
        state: present

    - name: Delete power_port within nautobot
      networktocode.nautobot.power_port:
        url: http://nautobot.local
        token: thisIsMyToken
        name: Test Power_Port
