...
short_description: Creates or removes rear port templates from Nautobot
description:
  - Creates or removes rear port templates from Nautobot
notes:
...
- name: "Test Nautobot modules"
  ...
  tasks:
    ...
    - name: Delete rear_port_template within nautobot
      networktocode.nautobot.rear_port_template:
        url: http://nautobot.local
        token: thisIsMyToken
        name: Test Rear_Port_Template
