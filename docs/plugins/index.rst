...
* :ref:`ip_address_to_interface module <ansible_collections.networktocode.nautobot.ip_address_to_interface_module>` -- Creates or removes IP address to interface association from Nautobot
...
* :ref:`role module <ansible_collections.networktocode.nautobot.role_module>` -- Create, update or delete roles within Nautobot
