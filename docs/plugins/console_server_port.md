...
!!! note "Collection Note"
    ...
    To use it in a playbook, specify: `networktocode.nautobot.console_server_port`.
...
| description | str | 3.0.0 | Description of the console server port |
| device | raw | 3.0.0 | The device the console server port is attached to |
| name | str | 3.0.0 | The name of the console server port |
...
| type | str | 3.0.0 | The type of the console server port |
...
| --- | --------- | ----------- | -------- |
| console_server_port | dict | Serialized object as created or already existent within Nautobot | success (when I(state=present)) |
