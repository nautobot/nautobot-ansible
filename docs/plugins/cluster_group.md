...
!!! note "Collection Note"
    ...
    To use it in a playbook, specify: `networktocode.nautobot.cluster_group`.
...
| description | str | 3.0.0 | The description of the cluster group |
| name | str | 3.0.0 | The name of the cluster group |
...
| --- | --------- | ----------- |
| cluster_group | string | Serialized object as created or already existent within Nautobot<br>Returned: always |
