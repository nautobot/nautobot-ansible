...
!!! note "Collection Note"
    ...
    To use it in a playbook, specify: `networktocode.nautobot.tenant_group`.
...
| name | str | 3.0.0 | Name of the tenant group to be created |
| parent_tenant_group | raw | 3.1.0 | Name of the parent tenant group |
...
| --- | --------- | ----------- |
| tenant_group | string | Serialized object as created or already existent within Nautobot<br>Returned: always |
