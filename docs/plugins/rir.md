...
!!! note "Collection Note"
    ...
    To use it in a playbook, specify: `networktocode.nautobot.rir`.
...
| is_private | bool | 3.0.0 | IP space managed by this RIR is considered private |
| name | str | 3.0.0 | The name of the RIR |
...
| rir | dict | Serialized object as created or already existent within Nautobot | success (when I(state=present)) |
