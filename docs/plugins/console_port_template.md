...
!!! note "Collection Note"
    ...
    To use it in a playbook, specify: `networktocode.nautobot.console_port_template`.
...
| device_type | raw | 3.0.0 | The device type the console port template is attached to |
| name | str | 3.0.0 | The name of the console port template |
...
| type | str | 3.0.0 | The type of the console port template |
...
| --- | --------- | ----------- | -------- |
| console_port_template | dict | Serialized object as created or already existent within Nautobot | success (when I(state=present)) |
