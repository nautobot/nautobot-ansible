...
!!! note "Collection Note"
    ...
    To use it in a playbook, specify: `networktocode.nautobot.team`.
...
| comments | str |  | Comments about the team |
| contacts | list |  | The contacts the team is associated with |
| custom_fields | dict | 3.0.0 | Must exist in Nautobot and in key/value format |
| email | str |  | The email of the team |
| name | str |  | The name of the team |
| phone | str |  | The phone number of the team |
...
| team | dict | Serialized object as created or already existent within Nautobot | success (when I(state=present)) |
