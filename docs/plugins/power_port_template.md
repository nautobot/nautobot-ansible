...
!!! note "Collection Note"
    ...
    To use it in a playbook, specify: `networktocode.nautobot.power_port_template`.
...
| device_type | raw | 3.0.0 | The device type the power port is attached to |
...
| --- | --------- | ----------- |
| power_port_template | string | Serialized object as created or already existent within Nautobot<br>Returned: always |
