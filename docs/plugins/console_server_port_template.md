...
| device_type | raw | 3.0.0 | The device type the console server port template is attached to |
| name | str | 3.0.0 | The name of the console server port template |
...
| type | str | 3.0.0 | The type of the console server port template |
...
| --- | --------- | ----------- | -------- |
| console_server_port_template | dict | Serialized object as created or already existent within Nautobot | success (when I(state=present)) |
