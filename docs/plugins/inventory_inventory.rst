...
.. note::
    This inventory plugin is part of the `networktocode.nautobot collection <https://galaxy.ansible.com/networktocode/nautobot>`_ (version 5.0.2).
...
.. list-table::
  ...
  * - .. raw:: html
    ...
    - .. raw:: html
      ...
      - :ansible-option-choices-entry:`"locations"`
