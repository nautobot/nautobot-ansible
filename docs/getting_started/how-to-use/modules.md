...
These same fields are required when creating a device via the [device](../../networktocode.nautobot/module/device.md) module, but with the important addition of **name**.
