...
Ansible Docs on Installing Collections - https://docs.ansible.com/ansible/latest/user_guide/collections_using.html#installing-collections
...
!!! note
    The following link provides detailed information on checking out pull requests locally: [GitHub](https://docs.github.com/en/free-pro-team@latest/github/collaborating-with-issues-and-pull-requests/checking-out-pull-requests-locally)
