...
ALLOWED_HOSTS = os.getenv("NAUTOBOT_ALLOWED_HOSTS", "{{ allowed_hosts }}").split(" ")
...
SECRET_KEY = os.getenv("NAUTOBOT_SECRET_KEY", "$onq&6@bv&*#41f2^tq0slz&@4q)efepq03vs_r#1^4op*$8ss")
